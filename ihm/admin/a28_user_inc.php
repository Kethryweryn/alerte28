...
{
	$array_result[] = "[". $user->id.",'". mysqli_real_escape_string($db->getMysqli(),$user->prenom)."','". mysqli_real_escape_string($db->getMysqli(),$user->nom)
			."','" .mysqli_real_escape_string($db->getMysqli(),$user->nom_service). "', '<a href=gestion.php?page=a28_user_add&uid=".$user->id."><img src=\'../img/wan_pencil.png\' height=25/></a>']";
}
